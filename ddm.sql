...
('Media', 'Productos de calidad media', 'Productos de calidad media', 'img2'),
('Baja', 'Productos de calidad baja', 'Productos de calidad baja', 'img3'),
...
(1, 'Mauricio', 'Pérez', 'García', '101', 'Mauricio.perez@emp.com', 'OF01', NULL, 'Gerente'),
(2, 'Ana', 'Martínez', 'López', '102', 'ana.martinez@emp.com', 'OF02', 1, 'Asistente'),
(3, 'Luis', 'González', 'Fernández', '103', 'luis.gonzalez@emp.com', 'OF03', 1, 'Vendedor'),
(4, 'María', 'Rodríguez', 'Sánchez', '104', 'maria.rodriguez@emp.com', 'OF04', 2, 'Administrativo'),
(5, 'Carlos', 'López', 'Martínez', '105', 'carlos.lopez@emp.com', 'OF05', 3, 'Vendedor'),
...
(1, 'Empresa A', 'Carlos', 'Sánchez', '915678910', '915678911', 'Calle Ejemplo 1', 'Piso 1', 'Madrid', 'Madrid', 'España', '28001', 1, 20000),
(2, 'Empresa B', 'Ana', 'García', '935678912', '935678913', 'Calle Ejemplo 2', '', 'Barcelona', 'Cataluña', 'España', '08001', 2, 70000),
...
('P002', 'Producto 2', 'Media', '20x20x20', 'Proveedor 2', 'Descripción del producto 2', 200, 80.00, 30.00),
('P003', 'Producto 3', 'Baja', '30x30x30', 'Proveedor 3', 'Descripción del producto 3', 300, 30.00, 20.00),
('P004', 'Producto 4', 'Premium', '40x40x40', 'Proveedor 4', 'Descripción del producto 4', 400, 40.00, 35.00),
('P005', 'Producto 5', 'Económico', '50x50x50', 'Proveedor 5', 'Descripción del producto 5', 500, 20.00, 15.00),
...
(1, '2024-01-01', '2024-01-05', '2024-01-02', 'Rechazado', 'Sin comentarios', 1),
(2, '2024-02-01', '2024-02-05', '2024-02-02', 'Completado', 'Sin comentarios', 2),
...
(5, '2024-05-01', '2024-05-05', '2024-05-02', 'Rechazado', 'Sin comentarios', 5),
...
(2, 'Efectivo', '2024-02-01', '2024-02-06', 800.00),
...
(6, 'Efectivo', '2024-06-01', '2024-06-06', 300.00);
